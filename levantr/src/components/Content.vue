            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <p class="card-text">
                      You must define <strong>container ID</strong>,
                      <strong>latitude</strong> and
                      <strong>longitude</strong> of the map's center.
                    </p>
                    <p class="card-text">
                      You also can define <strong>zoom</strong>,
                      <strong>width</strong> and <strong>height</strong>. By
                      default, zoom is 15. Width an height in a CSS class will
                      replace these values.
                    </p>
                    <p class="card-text">
                      Map types are defined in the
              ...
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <button
                      type="button"
                      class="btn btn-primary street-pitch mt-1 mr-1"
                    >
                      Change Pitch
                    </button>
                    <button
                      type="button"
                      class="btn btn-primary street-both mt-1"
                    >
                      Change Both
                    </button>
                  </div>
            ...
            <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <p class="card-text">
                      The Maps JavaScript API allows you to add bicycle
                      information to your maps using the
                      <strong>BicyclingLayer</strong> object.
                    </p>
                    <p class="card-text">
                      The <strong>BicyclingLayer</strong> renders a layer of
            ...
            <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <p class="card-text">
                      The Maps JavaScript API allows you to add real-time
                      traffic information (where supported) to your maps using
                      the <strong>TrafficLayer</strong> object.
                    </p>
                    <p class="card-text">
                      Traffic information is refreshed frequently,but not
